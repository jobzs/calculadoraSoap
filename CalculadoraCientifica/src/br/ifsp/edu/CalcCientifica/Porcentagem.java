...
public class Porcentagem implements ServicoInterface {
    private double valorInputA;
    private double valorInputB;
    private String operacao = "Porcentagem";
    ...
    public double calcular() throws Exception{       
        double resul = valorInputA * (valorInputB / 100);
        return resul; // <-- Retorna o "double" resultado da porcentagem.
        //Codigo a ser feito se o desejado fosse retornar uma porcentagem:
        //return valorInputB * 100 / valorInputA;
    }
